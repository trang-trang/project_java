...
public class Login_form extends javax.swing.JFrame {
    ...
    public Mainmenucallback _callback;
    /** Creates new form Login_form */
    public Login_form(Mainmenucallback callback) {
        initComponents();
        _callback = callback;
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        if(login != null)
        {
         ...
         System.out.println("trang thai dang nhap: " + dn);
          ...
          _callback.setLoginuser(login);
         if(login.role == 1)
         {
            _callback.setAdminmenu();
         }
         else
             if(login.role == 2)
             {
                   _callback.setTeachermenu();
             }
         else
                 if(login.role == 0)
                 {
                      _callback.setGuessmenu();
                 }
                 this.dispose();
        }
        else
